...
giant_robot_think( trig_stomp_kill_right, trig_stomp_kill_left, clip_foot_right, clip_foot_left, m_sole, n_robot_id )
{
    ...
    self.is_walking = 0;
    println( "^3[HRP] r" + n_robot_id + " final stopanimscripted (giant_robot_think cleanup)" );
...
{
    // GR-05 patch active — this line confirms the patched GSC is executing.
    println( "^2[HRP] robot_walk_animation r" + n_robot_id + " START  t=" + gettime() );
    ...
    if ( n_robot_id == 0 )
    {
        ...
        println( "^3[HRP] r0 seg0 animscripted" );
        ...
        println( "^3[HRP] r0 seg0 stopanimscripted" );
        self stopanimscripted();
        self thread maps\mp\animscripts\zm_shared::donotetracks( "scripted_walk" );
        println( "^3[HRP] r0 seg1 animscripted" );
        self animscripted( s_robot_path.origin, s_robot_path.angles, str_anim_scripted_name, 1 );
        self waittillmatch( "scripted_walk", "end" );
        println( "^3[HRP] r0 seg1 stopanimscripted" );
        self stopanimscripted();
        self thread maps\mp\animscripts\zm_shared::donotetracks( "scripted_walk" );
        println( "^3[HRP] r0 seg2 animscripted" );
        self animscripted( s_robot_path.origin, s_robot_path.angles, str_anim_scripted_name, 2 );
        self waittillmatch( "scripted_walk", "end" );
        // seg2 freed by giant_robot_think stopanimscripted()
        println( "^3[HRP] r0 walk END (seg2 pending giant_robot_think cleanup)" );
    ...
    else if ( n_robot_id == 1 )
    {
        ...
        s_robot_path.angles = ( 0, 0, 0 );
        println( "^3[HRP] r1 seg0 animscripted" );
        self animscripted( s_robot_path.origin, s_robot_path.angles, str_anim_scripted_name, 0 );
        self thread maps\mp\animscripts\zm_shared::donotetracks( "scripted_walk" );
        self waittillmatch( "scripted_walk", "end" );
        println( "^3[HRP] r1 seg0 stopanimscripted" );
        self stopanimscripted();
        self thread maps\mp\animscripts\zm_shared::donotetracks( "scripted_walk" );
        println( "^3[HRP] r1 seg1 animscripted" );
        self animscripted( s_robot_path.origin, s_robot_path.angles, str_anim_scripted_name, 1 );
        self waittillmatch( "scripted_walk", "end" );
        println( "^3[HRP] r1 seg1 stopanimscripted" );
        self stopanimscripted();
        self thread maps\mp\animscripts\zm_shared::donotetracks( "scripted_walk" );
        println( "^3[HRP] r1 seg2 animscripted" );
        self animscripted( s_robot_path.origin, s_robot_path.angles, str_anim_scripted_name, 2 );
        self waittillmatch( "scripted_walk", "end" );
        println( "^3[HRP] r1 walk END (seg2 pending giant_robot_think cleanup)" );
        self notify( "giant_robot_stop" );
    }
    else if ( n_robot_id == 2 )
    {
        ...
        s_robot_path.angles = ( 0, 0, 0 );
        println( "^3[HRP] r2 seg0 animscripted" );
        self animscripted( s_robot_path.origin, s_robot_path.angles, str_anim_scripted_name, 0 );
        self thread maps\mp\animscripts\zm_shared::donotetracks( "scripted_walk" );
        self waittillmatch( "scripted_walk", "end" );
        println( "^3[HRP] r2 seg0 stopanimscripted" );
        self stopanimscripted();
        self thread maps\mp\animscripts\zm_shared::donotetracks( "scripted_walk" );
        println( "^3[HRP] r2 seg1 animscripted" );
        self animscripted( s_robot_path.origin, s_robot_path.angles, str_anim_scripted_name, 1 );
        self waittillmatch( "scripted_walk", "end" );
        println( "^3[HRP] r2 seg1 stopanimscripted" );
        self stopanimscripted();
        self thread maps\mp\animscripts\zm_shared::donotetracks( "scripted_walk" );
        println( "^3[HRP] r2 seg2 animscripted" );
        self animscripted( s_robot_path.origin, s_robot_path.angles, str_anim_scripted_name, 2 );
        self waittillmatch( "scripted_walk", "end" );
        println( "^3[HRP] r2 walk END (seg2 pending giant_robot_think cleanup)" );
        self notify( "giant_robot_stop" );
    }
    else if ( n_robot_id == 3 )
    {
        ...
        s_robot_path = getstruct( "anim_align_robot_trenches", "targetname" );
        s_robot_path.angles = ( 0, 0, 0 );
        println( "^3[HRP] r3 seg0 animscripted (intro, no stopanimscripted here)" );
        self animscripted( s_robot_path.origin, s_robot_path.angles, str_anim_scripted_name, 0 );
        self thread maps\mp\animscripts\zm_shared::donotetracks( "scripted_walk" );
        self waittillmatch( "scripted_walk", "end" );
        println( "^3[HRP] r3 walk END" );
        self notify( "giant_robot_stop" );
    }
